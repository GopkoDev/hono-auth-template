  ...
  <Html>
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={tertiary}>Registration Confirmation</Text>
        <Heading style={secondary}>Welcome, {username}!</Heading>
        <Text style={paragraph}>
          To complete your registration, use this PIN code:
        </Text>
        <Section style={codeContainer}>
          <Text style={code}>{pin}</Text>
        </Section>
        <Text style={paragraph}>
          You have been automatically redirected to the verification page. If
